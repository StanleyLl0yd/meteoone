...
- manual testing of the APK is optional;
...
- a future stable version selected for RuStore is handled under the M7 stable-store gate, using the AAB already published in its GitHub Release.
